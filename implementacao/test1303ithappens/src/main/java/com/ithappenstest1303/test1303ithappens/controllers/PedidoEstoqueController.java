...
public class PedidoEstoqueController {
	...
	@RequestMapping(value="/{codigousuario}/{codigocliente}/{codigofilial}", method=RequestMethod.GET)
	public ModelAndView escolheFilial (@PathVariable("codigousuario") long codigousuario, @PathVariable("codigocliente") long codigocliente, @PathVariable("codigofilial") long codigofilial){
	...
	@RequestMapping(value="/{codigousuario}/{codigocliente}/{codigofilial}", method=RequestMethod.POST)
