...
public class ClienteController {
	...
	@GetMapping("/deletarcliente/{codigo}")
	public ModelAndView deletarCliente(@PathVariable("codigo") Long codigo) {
		Cliente cliente = cr.findByCodigo(codigo);
		cr.delete(cliente);
		ModelAndView modelAndView = new ModelAndView("redirect:/listaClientes");
		return modelAndView;
	}
}
